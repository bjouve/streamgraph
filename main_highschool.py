...
mon_fichier=open(dir+'highschool_data/High-School_data.txt', "r")
...
for d in range(d,d+1):
    ...
    for t in day_0_graph[d]:
        ...
        W_t_d[d][t]=W
        f = open(dir+'results/Input_W_highschool/W_day_%d_t0_%d.txt'%(d,t), "w")
        f.write('day %d \t t_0= %d \n' %(d,t))
        for e in W.edges():
            u=e[0]
            v=e[1]
        ...
        f = open(dir+'results/RC_highschool/segmentation_day_%d_t0_%d.txt'%(d,t), "w")
        f.write('t %d \n' %(t))
